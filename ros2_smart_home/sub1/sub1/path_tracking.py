    ...
    def timer_callback(self):
        ...
        if self.is_status and self.is_odom == True and self.is_path == True:
            ...
            if len(self.path_msg.poses) > 1:
                ...
                self.lfd = (self.odom_msg.twist.twist.linear.x +
                            lateral_error) * 0.5
                ...
                if self.is_look_forward_point:
                    ...
                    '''
                    trans_matrix = np.matmul(np.array([[1, 0, robot_pose_x],
                                                       [0, 1, robot_pose_y],
                                                       [0, 0, 1]]),
                                             np.array([[cos(self.robot_yaw), -sin(self.robot_yaw), 0],
                    ...
                    '''
                    # if -15 < theta * 180 / pi < 15:
                    #     out_vel = 1.0
                    #     out_rad_vel = theta * 0.03
                    # elif -30 < theta * 180 / pi < 30:
                    #     out_vel = 0.3
                    #     out_rad_vel = theta * 0.04
                    # else:
                    #     out_vel = 0.0
                    #     out_rad_vel = theta * 0.05
