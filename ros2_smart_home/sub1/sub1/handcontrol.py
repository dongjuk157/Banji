...
class Handcontrol(Node):
    ...
    def __init__(self):
        ...
        self.hand_control = self.create_publisher(
            HandControl, '/hand_control', 10)
    ...
    def timer_callback(self):
        ...
        # 로직 2. 사용자 메뉴 구성
        print(
            'Select Menu [0: status_check, 1: preview, 2:pick_up, 3:put_down')
        menu = input(">>")
        if menu == '0':
